...
def ACLogin(ip,id,passwd,isp):
    ...
    headers["Referer"]="http://172.16.2.100/a70.htm?wlanuserip="+ip+"&wlanacip=null&wlanacname=null&vlanid=0&ip="+ip+"&ssid=null&areaID=null&mac=00-00-00-00-00-00"
    ...
    acRequest=requests.post(url,params=payload,data=postData,cookies=cookiesData,headers=headers)
    TestLog(acRequest)
